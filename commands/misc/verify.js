...
module.exports = {
  run: async (client, message) => {
    const verifyTimeoutDelay = 30000;   //Sets the timeout of the command (default: 60000 aka 1 min)
    ...
    const emojiOne = { key: Object.keys(emojis)[Object.keys(emojis).length * Math.random() << 0] };
